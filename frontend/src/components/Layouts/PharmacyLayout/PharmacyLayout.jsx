...
import inventory from "../../../assets/images/icons8-management-48.png";
import dispensary from "../../../assets/images/icons8-dispensary-48.png";
import reporting from "../../../assets/images/icons8-reporting-48.png";
import StockAlerts from "../../../assets/images/icons8-notification-48.png";
...
export default function PharmacyLayout() {
  ...
  // Sidebar items
  const menuItems = [
    { label: "Dashboard", path: "/pharmacist", icon: dashboard },
    { label: "Inventory", path: "/pharmacist/inventory", icon: inventory },
    { label: "Dispensary", path: "/pharmacist/dispensary", icon: dispensary },
    { label: "Stock Alerts", path: "/pharmacist/lowstock", icon: StockAlerts },
    { label: "Reporting", path: "/pharmacist/reporting", icon: reporting },
  ];
